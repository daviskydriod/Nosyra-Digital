...
const HeroSection = () => {
  ...
  return (
    <section className="relative h-screen max-h-screen flex flex-col overflow-hidden bg-background">
      ...
      {/* ── CONTENT — fills exactly h-screen ── */}
      <div className="relative z-10 flex flex-col h-full pt-20">
        ...
        <motion.div
          ...
          className="flex items-center justify-between px-6 lg:px-12 pt-6"
        >
              ...
              <div key={lineIdx} className="overflow-hidden">
                <motion.h1
                  ...
                  className={`block font-poppins font-black tracking-tight leading-[0.92]
                    text-[clamp(3.5rem,10.5vw,9.5rem)]
                    ${line.accent
        ...
        <motion.div
          ...
          className="flex flex-col lg:flex-row items-start lg:items-end justify-between gap-6 px-6 lg:px-12 pb-8"
        >
          {/* LEFT — subtitle */}
          ...
          <div className="flex flex-col items-start lg:items-end gap-5">
            ...
            {/* Brand names — ultra dim */}
            <div className="flex flex-wrap items-center justify-end gap-x-4 gap-y-1 max-w-sm">
              {brands.map((brand, i) => (
                <motion.span
                  key={brand}
                  initial={{ opacity: 0 }}
                  ...
                  className="text-[9px] text-muted-foreground/20 font-semibold tracking-widest uppercase cursor-default transition-all"
                >
                  {brand}
                </motion.span>
              ))}
